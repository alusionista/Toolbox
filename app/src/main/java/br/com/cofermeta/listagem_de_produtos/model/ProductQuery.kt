...
import br.com.cofermeta.listagem_de_produtos.model.dataclasses.*
import br.com.cofermeta.listagem_de_produtos.data.*
import br.com.cofermeta.listagem_de_produtos.sankhya
import br.com.cofermeta.listagem_de_produtos.network.*
    ...
    fun tryQuery(context: Context, queryField: QueryFields): QueryResult {
        ...
        if (isOnline(context)) {
            MainScope().launch(Dispatchers.IO) {
                auth.updateJsession()
                this@ProductQuery.sankhyaQuery(queryField, queryResult)
                return@launch
            }
            while (true) {
